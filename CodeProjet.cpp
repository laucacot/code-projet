...
value_type DL (value_type d, value_type m)
{
  ...
  Diff_Libre=2.175742492e-35 *((pow(320,(3./2.)))/(pressure*pow(d,2)*pow((1./m+1./m_Ar),-0.5)));
...
public:
  ...
  void init() {
    ...
    DL_e=2.175742492e-35 *((320*pow(Te*11600,(1./2.)))/(pressure*pow(d_e,2)*pow((1./m_e+1./m_Ar),-0.5)));
